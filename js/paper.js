	...
	b.directive("tnUeditor", [function() {
		return {
			...
			link: function(a, b, c, d) {
				...
				"undefined" != typeof UE ? f() : (e = $("body"), $('<script type="text/javascript" src="/3rd/ueditor/20141210/ueditor.config.js"></script>').appendTo(e), g = $('<script type="text/javascript" src="/3rd/ueditor/20141210/ueditor.all.min.js"></script>').appendTo(e), g.ready(function() {
					return f()
				}))
			}
		}
...
function() {
	...
	i = function(a) {
		...
		b.prototype.setupScope = function(a) {
			...
			return this.panelLoc = this.$scope.panelLoc = q(),
			b = "ed-type-param",
			c = "http://statics.xiumi.us/stc/templates/tpl-a-1/assets/icons",
			a.paramGroups = {
				"tpl-a-1/multislider": [{
					type: b,
					paramType: "baozhiqi",
	...
	c = function(a) {
		...
		b.prototype.setupScope = function(a) {
			...
			c = function() {
				return {
					type: "ed-type-bg",
					url: "http://statics.xiumi.us/stc/images/placeholder-img.jpg",
					posX: "center",
					posY: "center",
					backgroundSize: "cover"
				}
...
function() {
	...
	g.factory("pagesManager", [function() {
		...
		window.__debug__ && (window.xmiData = e),
		{
			...
			setMetaData: function(a) {
				var b, c, f, g, h, i;
				if (null == a && (a = !1), a || "http://statics.xiumi.us/stc/images/placeholder-img.jpg" === e.cover) {
	...
	function(a, c, d, e, f, g) {
		...
		{
			init: function(b) {
				return a.get("/api/fragment/list").success(function(a) {
					var c;
			...
			push: function(b, c, d) {
				...
				i.push(f),
				a.post("/api/fragment/", f.data).success(function(a) {
					var b;
					return b = a.data,
			...
			remove: function(b) {
				...
				return c = i[b],
				i.splice(b, 1),
				a["delete"]("/api/fragment/" + c.fragment_id).success(function(a) {
					return a
				}).error(function(a) {
	...
	function(a, b, c, d) {
		...
		},
		{
			...
			initAudio: function(b) {
				return a.get("/api/asset/list/audio").success(function(a) {
					var c, e, f, g;
					if (d.isUserReady()) {
			...
			removeImage: function(b, d) {
				...
				e = o[b],
				o.splice(b, 1),
				(null != e && null != (f = e.assetImage) ? f.asset_id: void 0) ? a["delete"]("/api/asset/" + e.assetImage.asset_id).success(function() {
			...
			removeAudio: function(b, d) {
				...
				e = h[b],
				h.splice(b, 1),
				(null != e && null != (f = e.assetAudio) ? f.asset_id: void 0) ? a["delete"]("/api/asset/" + e.assetAudio.asset_id).success(function() {
					return "function" == typeof d ? d(null, !0) : void 0
				}).error(function(a) {
	...
	g.factory("colorsManager", [function() {
		var a, b;
		return a = ["transparent", "#f96e57", "#5f9cef", "#8ec965", "#47c1a8", "#ffffff", "#a0a0a0", "#ff8124", "#a65bcb", "#ffca00"],
		b = 0,
		{
			colors: function() {
				return a
		...
		},
		{
			...
			find: function(c, d) {
				return null == c || 0 === c ? "function" == typeof d ? d(new Error("Invalid: showId")) : void 0 : (f({
					...
					updating: !1,
					empty: !0
				}), a.get("/api/show/" + c).success(function(a) {
					return e(a.data),
...
function() {
	...
	y = angular.module("triton.studio.paper", ["ngRoute", "ngAnimate", "ngDragDrop", "ui.sortable", "ui.bootstrap", "angularSpectrumColorpicker", "triton.directives", "triton.infrastructure", "triton.editablePage", "triton.studio.operator", "triton.studio.services", "triton.studio.editing", "triton.xiumi.templates.parts"]),
	...
	function(a, c, d, e, f, g, h, j, k, l) {
		...
		o = function(b) {
			...
			h.submit("/api/asset/image/file", a.form).then(function(a) {
	...
	function(b, c, d, e, f, g, i, j) {
		...
		b.uploadAudioFile = function() {
			...
			c = e.maxAudioSize(),
			"mp3" !== a ? j.pushMessage(i.ASSET_FILE_TYPE_INVALID) : 0 === c ? j.pushMessage(i.AUDIO_NO_UPLOAD_ACCESS, "warning") : b.form.audio_file.size > c ? j.pushMessage(i.AUDIO_OUT_OF_SIZE, "danger") : (b.uploading = !0, g.submit("/api/asset/audio/file", b.form).then(function(a) {
