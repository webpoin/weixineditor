...
function() {
	...
	g.factory("colorsManager", [function() {
		var a, b;
		return a = ["transparent","#f91001", "#333", "#5f9cef", "#8ec965", "#47c1a8", "#ffffff", "#a0a0a0", "#ff8124", "#a65bcb", "#ffca00"],
		b = 0,
		{
			colors: function() {
				return a
	...
	function(a, b, c, d, e, f, g, h, i, m, r, u, w, y) {
		...
		C = function() {
			...
			b.find("*").each(function() {
				...
				J(a),
				A(a),
				a.addClass("tn-Powered-by-DIAOYONG")
			}),
			c = function(a, b) {
